...
A :class:`dict` with the metadata of the `sequence`_ is returned.

    >>> # Get the metadata of the sequence.
    ...
    >>> # Dump the metadata of the sequence as a JSON string to the console.
