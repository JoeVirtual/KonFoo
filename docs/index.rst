...
It aims to make the process of reading, decoding (de-serializing), viewing,
encoding (serializing) and writing binary data from and back to a data
provider as easy as possible.
