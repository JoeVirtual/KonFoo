# -*- coding: utf-8 -*-
#
# KonFoo documentation build configuration file, created by
...
html_sidebars = {
    'index':    ['sidebarlogo.html', 'sidebarintro.html', 'navigation.html', 'searchbox.html'],
...
# base_address URL from which the finished HTML is served.
#html_use_opensearch = ''
